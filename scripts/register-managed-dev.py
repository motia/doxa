#!/usr/bin/env python3
"""Register Koinon's externally supervised MCP service with managed-dev."""
...
SERVICE = "koinon-managed"
HOSTNAME = os.environ.get("KOINON_HOSTNAME", "koinon-managed.motiavated.com")
CONTAINER = "koinon-managed-mcp"
